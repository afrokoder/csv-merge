...
def palindrome_checker():
    ...
    reversed_user_input = reversed(user_input) #find the reverse user_input of the string

    if (list(user_input) == list(reveresed_user_input)): # No errors here
...
def days_in_month():
    ...
    cal_dict = {'jan':31, 'feb':28, 'mar':31, 'smarch':30, 'apr':30, "may":31, 'jun':30, 'jul':   31, 'aug': 30,
...
print ("\n\n")
print ("1. Simple Calculator (interger and floats")
